...
public class RaceTrack
{
	...
	public static void main(String[] args)
	{
		...
		RaceCar car1 = new RaceCar("Racer X", 10.0, 10.0); // wins 1st Race;
		RaceCar car2 = new RaceCar("Racer Y", 15.0, 5.0); // wins 2nd Race
	    RaceCar car3 = new RaceCar("Racer Z", 20.0, 4.0); // wins 3rd Race
